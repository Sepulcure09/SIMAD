    ...
    <div id="tambahKB" class="w3-modal " style="margin-left:0px ">
      <div class="w3-modal-content">
        <header class="w3-container w3-teal">
          <span onclick="document.getElementById('tambahKB').style.display='none'" class="w3-button w3-display-topright">&times;</span>
          <h2>Tambah Data</h2>
        </header>
        <div class="w3-container">
          ...
          <form class="w3-container" method="POST">
            ...
            <p>
              ...
              <input class="w3-input w3-border w3-sand" name="merk" type="text">
            </p>

            <p>
              <label class="w3-text-brown"><b>No Mesin</b></label>
              <input class="w3-input w3-border w3-sand" name="no_mesin" type="text">
            </p>

            <p>
              <label class="w3-text-brown"><b>Status</b></label>
              <input class="w3-input w3-border w3-sand" name="status" type="text">
            </p>

            <p>
              <label class="w3-text-brown"><b>Tahun Beli</b></label>
              <input class="w3-input w3-border w3-sand" name="th_beli" type="date">
            </p>

            <p>
              <label class="w3-text-brown"><b>Jumlah</b></label>
              <input class="w3-input w3-border w3-sand" name="jumlah" type="text">
            </p>
            <p>
              <label class="w3-text-brown"><b>Satuan Harga</b></label>
              <input class="w3-input w3-border w3-sand" name="stn_hrg" type="text">
            </p>


            <p>
              <button type="submit" name="simpan" class="w3-btn w3-brown">Simpan</button>
            </p>
          </form>
        </div>
