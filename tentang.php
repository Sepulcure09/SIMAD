			...
			<div class="row justify-content-center">
				<div class="col-lg-12 text-center">
					<div class="section-title">
						<h2>SISTEM INFORMASI INVENTARISASI ASET KANTOR DESA SASAK PANJANG</h2>
			...
			<div class="row">
				<div class="col-lg-4 col-md-6 col-sm-6">
					<div class="service-item mb-4">
						...
						<div class="content">
							<p class="mb-4">Hafizh Dwi Falihaqil<br>1941720126</p>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-4 col-md-6 col-sm-6">
					<div class="service-item mb-4">
						...
						<div class="content">
							<p class="mb-4">Ahmadi Yuli Ananta, ST., M.M.<br>NIP:198107052005011002</p>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-12 col-md-12 col-sm-12 w3-center">
					<div class="service-item mb-12 ">
						...
						<div class="content">
							<p class="mb-4">STUDI KASUS DI DESA SASAK PANJANG</p>
						</div>
					</div>
				</div>
