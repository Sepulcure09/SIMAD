...
<body id="top">
  ...
  <div class="widget mb-0 mb-lg-0">
    <ul class="list-inline footer-socials mt-4">
      <li class="list-inline-item"><a href="https://www.facebook.com/"><i class="icofont-facebook"></i></a></li>
      <li class="list-inline-item"><a href="https://instagram.com/"><i class="icofont-instagram"></i></a></li>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-4 col-sm-4 col-md-6">
          <div class="contact-block mb-0 mb-lg-0">
