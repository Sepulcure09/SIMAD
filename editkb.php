...
<body id="top">
  ...
  if (isset($_POST['simpan'])) {
    ...
    $aset->EditKB($id, $no_brg, $model, $merk, $no_mesin, $status, $tgl, $th_beli, $jumlah, $stn_hrg);
    echo "<script>
          alert('Data Berhasil Diubah');
            window.location='tampilkb.php';
        </script>";
  }
    ...
    <div class="container mt-3">
      ...
      <form action="" method="POST">
        <div class="mb-3 mt-3">
          ...
          $query = "SELECT * FROM crudkb WHERE id=" . $_GET['id'];
        ...
        <div class="mb-3">
          ...
          <input type="text" value="<?php echo $row['no_mesin'] ?>" class="form-control" id="no_mesin" name="no_mesin">
        </div>
        <div class="mb-3 mt-3">
  ...
  <footer>
    <div class="text-center p-3" style="background-color: #003366">
      © <b>2021 Copyright: Ardian Mulya Diniar & Muhamad Adzriel Akbar | Repost by <a href='https://stokcoding.com/' title='StokCoding.com' target='_blank'>StokCoding.com</a></b>
